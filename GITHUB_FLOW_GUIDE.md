...
予定されている主要 feature ブランチ：

| ブランチ | 説明 | 優先度 | 期間 |
|---------|------|--------|------|
| `feature/supabase-setup` | DB・テーブル設計・RLS基本設定 | 🔴 高 | 3/1～3/7 |
| `feature/user-auth` | ユーザー認証（メール+パスワード） | 🔴 高 | 3/5～3/12 |
| `feature/user-permissions` | 3段階ロール実装（ゲスト/一般/管理者） | 🔴 高 | 3/10～3/17 |
| `feature/blog-page` | ブログ一覧・カード表示・ページネーション | 🔴 高 | 3/12～3/20 |
| `feature/polish-ui` | 雑誌掲載用 UI ブラッシュアップ | 🔴 高 | 3/18～3/28 |
